...
## 1. Complete frontend → backend feature matrix
...
### 2.3 Frontend integration seam (no UI rewrite)
...
### 5.1 Three portals, three sessions
...
## 6. Product lifecycle implementation plan

### 6.1 Canonical stages (keep)
...
### 6.2 Command table (backend must be identical)
...
### 6.3 Publish validator (port as-is)
...
## 8. Marketing media architecture
...
### 9.1 Current (unsafe for production)
